...
namespace Rad {
	...
	class UTIL_ENTRY IPropertyGrid_UserCreator
	{
	public:
		...
		virtual PropertyField * 
			CreatePropertyField(PropertyGroup * group, IObject * obj, const Property * prop) = 0;
	};

	class UTIL_ENTRY PropertyGrid : public MGUI::Widget
	{
	public:
