...
DF_PROPERTY_BEGIN(MaterialProperty)
	...
	DF_PROPERTY_EX(MaterialProperty, emissive, "Material", "Emissive", "PT_Color3", PT_Float3)
	DF_PROPERTY_EX(MaterialProperty, ambient, "Material", "Ambient", "PT_Color3", PT_Float3)
	DF_PROPERTY_EX(MaterialProperty, diffuse, "Material", "Diffuse", "PT_Color3", PT_Float3)
	DF_PROPERTY_EX(MaterialProperty, specular, "Material", "Specular", "PT_Color3", PT_Float3)
