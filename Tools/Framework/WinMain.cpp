...
void _OnOleDragFile(const char * filename)
{
	App::Instance()->OnDragFile(filename);
}
...
LRESULT CALLBACK WndProc(HWND hWnd,UINT iMsg,WPARAM wParam,LPARAM lParam) 
{
	...
	case WM_DESTROY:
		Util_SetDragFileCallback(hWnd, NULL);
		PostQuitMessage(0);
		break;
...
static const char * WIN32_CLASS_NAME = "Rad Game";
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	Util_SetDragFileCallback(hWnd, _OnOleDragFile);
